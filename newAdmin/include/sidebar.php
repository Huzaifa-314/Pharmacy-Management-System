        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="page-layouts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="boxed-layout.html">All Orders</a></li>
                <li class="nav-item"> <a class="nav-link" href="rtl-layout.html">Cupon Code</a></li>
                <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="horizontal-menu.html">Payment Gateway</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="icons">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../icons/flag-icons.html">Add New User</a></li>
                <li class="nav-item"> <a class="nav-link" href="../icons/font-awesome.html">View all Users</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <div class="nav-link font-weight-bold">Pages</div>
          </li>
          <li class="nav-item">
