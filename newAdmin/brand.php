                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          <td>1</td>
                          <td><img width="60px " height="60px" alt="logo"></td>
                          <td > Beximco</td>
                          <td><label class="badge badge-success badge-pill">Active</label></td>
                          <td align="center"> <button class="btn btn-primary m-2 bg-success">Edit</button><button class="btn btn-primary m-2 bg-danger">Delete</button></td>
                        </tr>
                        <tr>
                          <td>2</td>
                          ...
                          <td > Incepta </td>
                          <td><label class="badge badge-success badge-pill">Active</label></td>
                          <td><p align="center"><button class="btn btn-primary m-2 bg-success">Edit</button><button class="btn btn-primary m-2 bg-danger">Delete</button></p></td>
                        </tr>
